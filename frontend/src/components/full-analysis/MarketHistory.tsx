...
interface Props {
    ...
    onSelect: (item: MarketHistoryItem) => void;
    onDelete: (id: string) => void;
    onClose: () => void;
}

export default function MarketHistory({ history, onSelect, onDelete, onClose }: Props) {
            ...
            <div style={{
                ...
                <div style={{ padding: "24px", borderBottom: "1px solid rgba(255,255,255,0.05)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        <h2 style={{ color: "white", fontSize: "1.2rem", fontWeight: 700 }}>Market Analysis History</h2>
                    </div>
                                ...
                                <div key={item.id} style={{
                                    ...
                                    >
                                        <div style={{ color: "white", fontWeight: 600, marginBottom: "4px" }}>
                                            {item.target_role} • {item.location}
                                        </div>
