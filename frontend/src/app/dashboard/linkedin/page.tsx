            ...
            <div style={{ paddingLeft: "50px" }}>
                ...
                {loading && (
                    ...
                    >
                        ...
                        <h3 style={{ fontSize: "1.5rem", fontWeight: 700, color: "white", marginBottom: "8px" }}>Analyzing your LinkedIn profile...</h3>
                        <p style={{ color: "rgba(255,255,255,0.5)", maxWidth: "500px", margin: "0 auto" }}>
                            Our AI Recruiters are scanning your headline, about section, and experience for optimization opportunities.
                        </p>
