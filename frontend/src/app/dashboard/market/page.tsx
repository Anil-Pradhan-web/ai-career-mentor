        ...
        <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg-primary)", position: "relative", overflow: "hidden" }}>
            ...
            >
                ...
                >
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ color: "#94a3b8", fontSize: "15px" }}>Live job market trends and salary data.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="glass animate-fade-up-delay-1" style={{ padding: "40px", textAlign: "center", borderRadius: "20px" }}>
                    <div style={{
                        width: "80px", height: "80px", borderRadius: "50%", background: "rgba(6,182,212,0.1)",
                        display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px"
                    }}>
                        <Rocket size={40} color="#22d3ee" className="animate-float" />
                    </div>
                    ...
                    <p style={{ color: "#94a3b8", maxWidth: "500px", margin: "0 auto" }}>
                        The Job Market trends agent is arriving in Day 5! It will pull real live job data using Azure MCP or Bing Search.
                    </p>
                </div>
            </main>
        </div>
