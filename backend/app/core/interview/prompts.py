...
def _build_feedback_system_prompt(role: str, company: str, interview_type: str = "technical") -> str:
    ...
    return (
        ...
        "2. Structure your feedback clearly using the following sections, keeping it short, direct, and actionable:\n"
        "   - **Executive Summary:** A brief 2-sentence verdict on their overall performance.\n"
        "   - **Strengths:** Specific moments where the candidate shined (max 3 concise bullet points, 1-2 sentences each).\n"
        "   - **Areas of Improvement:** Specific moments where they answered incorrectly, vaguely, or failed to communicate clearly (max 3 concise bullet points, 1-2 sentences each).\n"
        "   - **Actionable Advice:** What they need to study or practice before their next interview (max 3 concise bullet points, 1-2 sentences each).\n"
        "3. Tone: Professional, highly constructive, and direct. Do not sugarcoat failures. Keep the overall report short and highly readable.\n"
